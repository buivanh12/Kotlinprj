                ...
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="#"><i class="fa fa-envelope-o"></i>admin@admin</a></li>
                    ...
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            ...
                            <?php while ($rowCategory = $resultCategory->fetch_assoc()) { ?>
                                <li><a href="../client/store.php?detailsProductStatus=<?= $rowCategory['id_productStatus']; ?>" value="<?= $rowCategory['id_productStatus']; ?>" name="testdd24"> <?= $rowCategory['type_productName'] ?> </a></li>
                            <?php } ?>
