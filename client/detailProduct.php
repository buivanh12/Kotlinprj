...
<head>
    ...
    <title>Chi tiêt sản phẩm sữa</title>
                    ...
                    <form action="" method="post">
                        <div class="product-details">
                            ...
                            <div>
                                ...
                                <h3 class="product-price" name="sale" value="<?= $row['sale'] ?>"><?= number_format($row['sale']) ?>
                                            ...
                                            <div class="panel panel-info">
                                                <div class="panel-body">
                                                    <form class="form-inline" method="post" action="">
                                                        <textarea placeholder="Viết Nhận Xét Ở đây!" name="commentContent" class="pb-cmnt-textarea" required><?php echo $commentContent ?></textarea>
                                                        ...
                                                        <div class="btn-group" style="padding-top: 10px">
                                                            ...
                                                            ?>
                                                                <?php if ($update_comment == true) { ?>
                                                                    <input type="text" name="id_comment" value="<?= $rowComment['id_comment'] ?>" hidden>
                                                                    <button class="btn btn-success pull-right" name="updateSubmit" type="submit">Xác Nhận Chỉnh Sửa
                                                                    </button>
                                                                <?php } else { ?>
                                                                    <button class="btn btn-danger pull-right" name="commentSubmit" type="submit">Nhận Xét
                                                                    </button>
                                                            <?php }
                                                            } ?>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <form action="" method="post">
                                                                <div class="col-md-2">
                                                                    <img src="<?= $rowComment['avatar'] ?>" class="img img-rounded img-fluid" width="80" height="80" />
                                                                    <p class="text-secondary text-center"><?= $rowComment['cur_date'] ?></p>
                                                                </div>
                                                                <div class="col-md-10">
                                                                    <p>
                                                                        <a class="float-left" href="https://maniruzzaman-akash.blogspot.com/p/contact.html"><strong><?= $rowComment['name'] ?></strong></a>
                                                                        <span class="float-right"><i class="text-warning fa fa-star"></i><?= $rowComment['type_user'] ?><i </p>
                                                                                ...
                                                                                <p>
                                                                                    ...
                                                                                    <?php if ($_SESSION['id_user'] == $rowComment['id_user']) { ?>
                                                                                        <button name="deleteComment" class="btn btn-warning" onclick="return confirm('Bạn Chắc Chắn Muốn Xóa Comment Này?');">
                                                                                            Xóa
                                                                                        </button>
                                                                                    ...
                                                                                    <?php } else { ?>
                                                                                        ...
                                                                                        <a class="float-right btn text-white btn-danger"> <i class="fa fa-heart"></i> Thích</a>
                                                                                    <?php
                                                                                    }
                                                                                    ?>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-name"><a href="../client/detailProduct.php?detailProduct=<?= $row['id_product']; ?>"><?= $row['name_product']; ?> </a>
                                </h3>
