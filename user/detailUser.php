                            ...
                            <div class="col-lg-4 col-xl-3">
                                <div class="profile-content-left pt-5 pb-3 px-3 px-xl-5">
                                    <div class="card text-center widget-profile px-0 border-0">
                                        <div class="mx-auto rounded-circle" style="width: 200px; height: 200px; background-color: #ccc; text-align: center; display: flex; align-items: center; justify-content: center; border-radius: 50%;">
                                            <img src="<?= $_SESSION['avatar']; ?>" alt="user image" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                                        </div>
                                        <div class="card-body">
                            ...
                            <div class="col-lg-8 col-xl-9">
                                <div class="profile-content-right pt-5 pb-3 px-3 px-xl-5">
                                    ...
                                    <div class="contact-info">
                                        <h5 class="text-dark mb-1">THÔNG TIN CÁ NHÂN</h5>
