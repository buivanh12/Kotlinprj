...
<head>
    ...
    <title>Cửa hàng bán đồ gia dụng</title>
                                ...
                                <?php while ($rowProductStatus = $resultProductStatus->fetch_assoc()) { ?>
                                    ...
                                    <div class="input-checkbox">
                                        ...
                                        <label for="<?= $rowProductStatus['id_productStatus'] ?>">
                                            ...
                                            <a href="../client/store.php?detailsProductStatus=<?= $rowProductStatus['id_productStatus']; ?>" value="<?= $rowProductStatus['id_productStatus']; ?>" name="testdd24"> <?= $rowProductStatus['type_productName']; ?> </a>
                                        </label>
                            ...
                            <?php while ($rowProduct = $resultProduct->fetch_assoc()) { ?>
                                ...
                                <div class="product-widget">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name"><a href="../client/detailProduct.php?detailProduct=<?= $rowProduct['id_product']; ?>"><?= $rowProduct['name_product'] ?></a>
                                        </h3>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="product">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name" style="height: 50px"><a href="../client/detailProduct.php?detailProduct=<?= $row['id_product']; ?>"><?= $row['name_product'] ?></a>
                                        </h3>
                                    ...
                                    <div class="add-to-cart">
                                        <a href="../client/detailProduct.php?detailProduct=<?= $row['id_product']; ?>"><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>Xem Ngay</button></a>
                                    </div>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-name"><a href="../client/detailProduct.php?detailProduct=<?= $rowCare['id_product']; ?>"><?= $rowCare['name_product'] ?></a></h3>
