                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card-header border-bottom">
                                                ...
                                                <form action="" method="post">
                                                    <input type="hidden" name="tongtien" value="<?= $row1['tongtien'] ?>">
                                                    <input type="hidden" name="id_user" id="" value="<?= $row1['id_user'] ?>">
                                                    <button style="margin-left: 10px;" type="submit" name="congdiem" class="btn btn-primary">
